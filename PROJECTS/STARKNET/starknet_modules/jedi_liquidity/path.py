...
ACCOUNTS_DIR = os.path.join(os.path.join(ROOT_DIR))
...
JEDISWAP_DAIUSDT_ABI_PATH = os.path.join(ABIS_DIR, 'jediswap_daiusdt.json')
JEDISWAP_DAIUSDC_ABI_PATH = os.path.join(ABIS_DIR, 'jediswap_daiusdc.json')
JEDISWAP_DAIETH_ABI_PATH = os.path.join(ABIS_DIR, 'jediswap_daieth.json')

DMAIL_ABI_PATH = os.path.join(ABIS_DIR, 'dmail.json')

UPGRADE_ABI_PATH = os.path.join(ABIS_DIR, 'upgrade.json')
