...
with open('PROJECTS/STARKNET/data/rpc.json') as file:
    RPC = json.load(file)

with open("PROJECTS/STARKNET/accounts.txt", "r") as file:
    ACCOUNTS = [row.strip() for row in file]

with open("PROJECTS/STARKNET/recipients.txt", "r") as file:
    RECIPIENTS = [row.strip() for row in file]

with open('PROJECTS/STARKNET/data/abi/erc20_abi.json') as file:
    ERC20_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/bridge/deposit_abi.json') as file:
    DEPOSIT_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/bridge/withdraw_abi.json') as file:
    WITHDRAW_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/orbiter/deposit.json') as file:
    ORBITER_DEPOSIT_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/orbiter/withdraw.json') as file:
    ORBITER_WITHDRAW_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/jediswap/abi.json') as file:
    JEDISWAP_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/myswap/abi.json') as file:
    MYSWAP_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/10kswap/abi.json') as file:
    STARKSWAP_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/sithswap/abi.json') as file:
    SITHSWAP_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/protoss/abi.json') as file:
    PROTOSS_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/fibrous/abi.json') as file:
    FIBROUS_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/zklend/abi.json') as file:
    ZKLEND_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/dmail/abi.json') as file:
    DMAIL_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/starknet_id/abi.json') as file:
    STARKNET_ID_ABI = json.load(file)

with open('PROJECTS/STARKNET/data/abi/pyramid/abi.json') as file:
